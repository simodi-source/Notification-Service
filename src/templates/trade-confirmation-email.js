...
function buildTradeConfirmationEmail(input) {
  ...
  const appNote = isBuy
    ? "Your investment certificate is attached to this email. You can also view this trade and your updated metal balance in the SIMODI app."
    : "You can view this trade and your updated metal balance in the SIMODI app.";
